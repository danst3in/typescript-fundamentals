...
const x: NumVal = [1,2,3,1,1,[3,1,1,2]]; // working example,ex: breaks if u add a 4
...
// example for testing if the interface is define correctly above or used for 'type narrowing'
