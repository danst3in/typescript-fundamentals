...
// be careful because the push array method is not type safe in the same way
// push in this case would allow a string or number at any position and even
// make the array too long
...
// const zzz: any = {} as never; // ignore this line
