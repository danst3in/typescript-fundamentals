 ...
 */
                    // T must be an object and it must have a property called id
                    // function accepts a type T that is at least an object with
                    // the property id whose value is a string
...
function startTuple<T>(a: T) {
  // no access to b parameter here, similarly no access to U type here in outer scope
